Non-service affecting intermediate template to go to the R7 double lane release. This is the first of two steps for your upgrade to the new R7 template.
