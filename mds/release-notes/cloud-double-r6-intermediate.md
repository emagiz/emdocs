Non-service affecting intermediate template to go to the R6 double lane release. This is the first of two steps for your upgrade to the new R6 template.
