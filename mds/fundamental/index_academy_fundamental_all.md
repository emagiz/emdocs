<div class="ez-academy">
	...
	<div class="card-container">
		...
		<a href="../../docs/fundamental/fundamental-data-models" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/MessageStructure.svg) center no-repeat; background-size: 15%;">
				<h4 class="title">Data Models</h4>
			</div>
			<ul class="card__footer">
				<li class="card__footer-item">
					<img class="card__footer-icon card__footer-icon--level" src="../../img/microlearning/academy_index/icon-level24.svg"/>
