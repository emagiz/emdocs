...
To get a new version of the eMagiz Mendix Connector in a Mendix app, the following steps from above need to be performed:
   ...
   4) Ensure to double check the functioning of the eMagiz Connector in case Mendix V8 is used - please refer to the V8 specific guide for more information
   5) In the best practice document for the eMagiz Mendix Connector there is a list of possible errors and quick fixes for them, so in case you have any errors you should check it because you might find a solution there. It is highly recommended to try the eMagiz Cleanup Tool.
