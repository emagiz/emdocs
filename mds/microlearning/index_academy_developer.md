<div class="ez-academy">
	...
	<div class="card-container">
		...
		<a href="../../docs/microlearning/intermediate-data-pipelines-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/DataPipelines_Modules.svg) center no-repeat; background-size: 20%;">
		...
		<a href="../../docs/microlearning/intermediate-database-connectivity-index" class="card">
		...
		<a href="../../docs/microlearning/advanced-solution-architecture-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/SolutionArchitecture_Modules.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">Solution Architecture</h4>
			</div>
			<ul class="card__footer">
				<li class="card__footer-item">
		...
		<a href="../../docs/microlearning/advanced-cloudmanagement-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/cloud-management-module.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">eMagiz Cloud Management</h4>
			</div>
			<ul class="card__footer">
			...
			<a href="../../docs/microlearning/advanced-key-concepts-platform-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/platform_crashcourse.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">Key Concepts of the platform</h4>
			</div>
			<ul class="card__footer">
				<li class="card__footer-item">
					<img class="card__footer-icon card__footer-icon--level" src="../../img/microlearning/academy_index/icon-level24.svg"/>
		...
		<a href="../../docs/microlearning/advanced-keyconcepts-eventstreaming-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/eventstreaming_crashcourse.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">Key Concepts Event Streaming</h4>
			</div>
			<ul class="card__footer">
		...
		<a href="../../docs/microlearning/advanced-monitoring-eventstreaming-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/eventstreaming_crashcourse.svg) center no-repeat; background-size: 20%;">
		...
		<a href="../../docs/microlearning/advanced-key-concepts-datamodeling-validation-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/orchestration_modules.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">Data Modeling and Validation</h4>
			</div>
			<ul class="card__footer">
				<li class="card__footer-item">
					<img class="card__footer-icon card__footer-icon--level" src="../../img/microlearning/academy_index/icon-level24.svg"/>
		...
		<a href="../../docs/microlearning/advanced-risk-management-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/Testing_modules.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">Risk Management</h4>
			</div>
			<ul class="card__footer">
		...
		<a href="../../docs/microlearning/advanced-data-management-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/Testing_modules.svg) center no-repeat; background-size: 20%;">
		...
		<a href="../../docs/microlearning/advanced-monitoring-apigateway-index" class="card">
			<div class="card__body" style="background: url(../../img/microlearning/academy_index/api-management.svg) center no-repeat; background-size: 20%;">
				<h4 class="title">Advanced Monitoring API Gateway</h4>
			</div>
			<ul class="card__footer">
				<li class="card__footer-item">
					<img class="card__footer-icon card__footer-icon--level" src="../../img/microlearning/academy_index/icon-level24.svg"/>
